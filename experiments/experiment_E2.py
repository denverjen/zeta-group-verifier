...
transitions[('q_imag', ',')] = ('q_verify', '1', 'R')
transitions[('q_verify', '1')] = ('q_skip', '4', 'R')
# Skip imaginary part
transitions[('q_skip', '4')] = ('q_skip', '4', 'R')
...
print("===== Experiment E2: Counter + fixed imaginary part =====")
